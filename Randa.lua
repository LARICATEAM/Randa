...
SUDO = SUDO
sudo_users = {SUDO,1307427795,1307427795,1307427795,1307427795}   
print([[
> CH › @OO0a0
> CH › @zZvzZo
~> DEVELOPER › @BBPBa
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/RandaTEAM/Files_Randa/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevRandaW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevRandaW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevRandaW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevRandaW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevRandaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevRandaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevRandaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1307427795) then  
var = true  
elseif tonumber(user_id) == tonumber(1307427795) then
var = true 
elseif tonumber(user_id) == tonumber(1307427795) then
var = true
elseif tonumber(user_id) == tonumber(1307427795) then
...
local UserName = (data.username_ or "OO0a0")
...
local Randa_Msg = ''  
if msgs < 100 then 
Randa_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Randa_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Randa_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Randa_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Randa_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Randa_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Randa_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Randa_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Randa_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Randa_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Randa_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Randa_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Randa_Msg = 'رب التفاعل'  
end 
return Randa_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@BBPBa")  
...
--------------------------------------------------------------------------------------------------------------
function SourceRanda(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
Namot = (database:get(bot_id..'Name:Bot') or 'روليكس')
SourceRandar = '*◈︙اهلا عزيزي*\n*◈︙انا بوت اسمي '..Namot..'*\n*◈︙اختصاصي حمايه الكروبات*\n*◈︙من تكرار والسبام والتوجيه والخ…*\n*◈︙لتفعيلي اتبع الاخطوات…↓*\n*◈︙اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط*\n◈︙[قناة سورس البوت](http://t.me/OO0a0)'
end
send(msg.chat_id_, msg.id_, SourceRandar) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevRandaW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevRandaW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,Randa_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ◈' and DevRandaW(msg) then  
...
if text == 'تعطيل التواصل ◈' and DevRandaW(msg) then  
...
if text == 'تفعيل البوت الخدمي ◈' and DevRandaW(msg) then  
...
if text == 'تعطيل البوت الخدمي ◈' and DevRandaW(msg) then  
...
if text == 'ضع كليشه ستارت ◈' and DevRandaW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *◈︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ◈' and DevRandaW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *◈︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ◈' and DevRandaW(msg) then 
...
if text == 'تحديث السورس ◈' and DevRandaW(msg) then 
os.execute('rm -rf Randa.lua')
os.execute('wget https://raw.githubusercontent.com/LARICATEAM/Randa/main/Randa.lua')
send(msg.chat_id_, msg.id_,' *◈︙تم تحديث السورس* \n*◈︙لديك اخر اصدار لسورس روليكس*\n*◈︙الاصدار » { 2.8v}*')
dofile('Randa.lua')  
end
if text == 'الاصدار ◈' and DevRandaW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *◈︙اصدار سورس روليكس* \n*◈︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ◈' and DevRandaW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ◈︙[تحديثات البوت](t.me/zZvzZo) \n◈︙[قناه السورس](t.me/OO0a0)')
end
if text == "ضع اسم للبوت ◈" and DevRandaW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *◈︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ◈' and DevRandaW(msg) then 
...
if text == 'المشتركين ◈' and DevRandaW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *◈︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ◈' and DevRandaW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *◈︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ◈") and DevRandaW(msg) then
...
if text == ("قائمه العام ◈") and DevRandaW(msg) then
...
if text == ("قائمه الكتم العام ◈") and DevRandaW(msg) then
...
if text=="اذاعه خاص ◈" and msg.reply_to_message_id_ == 0 and DevRandaW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *◈︙ارسل الان اذاعتك؟* \n*◈︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ◈" and msg.reply_to_message_id_ == 0 and DevRandaW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *◈︙ارسل الان اذاعتك؟* \n*◈︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ◈" and msg.reply_to_message_id_ == 0 and DevRandaW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *◈︙ارسل الان اذاعتك؟* \n*◈︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ◈" and msg.reply_to_message_id_ == 0  and DevRandaW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *◈︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ◈" and msg.reply_to_message_id_ == 0  and DevRandaW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ◈︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ◈' and DevRandaW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ◈" and DevRandaW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ◈" and DevRandaW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*◈︙عدد الكروبات الان » { '..#group..' }'..Randak..''..Randa..'*\n*◈︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevRandaW(msg) then
...
usertext = '*\n ◈︙العضو »* ['..result.title_..'](t.me/'..(username or 'OO0a0')..')'
status  = '\n *◈︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevRandaW(msg) then
...
usertext = '\n *◈︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'OO0a0')..')'
status  = '\n*◈︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevRandaW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevRandaW(msg) then
...
local Randa1_Msg = database:get(bot_id.."Randa1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Randa1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *◈︙العضو »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'OO0a0')..') \n ◈︙'..Randa1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Randa_Msg and not Special(msg) then  
local Randa_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Randa_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *◈︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n◈︙["..Randa_Msg.."] \n")
else
send(msg.chat_id_,0," *◈︙العضو :* {["..data.first_name_.."](T.ME/OO0a0)}\n◈︙["..Randa_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *◈︙عذرا »* {["..data.first_name_.."](T.ME/OO0a0)}\n*◈︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevRandaW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevRandaW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevRandaW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *◈︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevRandaW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *◈︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ◈" and DevRandaW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *◈︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ◈$") and DevRandaW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *◈︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ◈" and DevRandaW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ◈" and DevRandaW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *◈︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ◈" and DevRandaW(msg) then  
...
database:sadd(bot_id.."Randa:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Randa:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_Randa = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_Randa then 
names_Randa = database:smembers(bot_id.."Randa:blocname"..msg.chat_id_) or ""
if names_Randa and names_Randa[1] then 
for i=1,#names_Randa do 
if name_Randa:match("(.*)("..names_Randa[i]..")(.*)") then 
...
database:set(bot_id.."Randa:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Randa:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Randa:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Randa:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Randa:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Randaa_new(Randa1,Randa2)
if Randa2 and Randa2.first_name_ then 
if Randa2.first_name_:match("(.*)"..database:get(bot_id.."Randa:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Randa:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Randa_nnn = database:get(bot_id.."Randa:nump"..msg.chat_id_) or 5
local Randa_nnn2 = database:get(bot_id.."Randa:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Randa_nnn2) == tonumber(Randa_nnn) or tonumber(Randa_nnn2) > tonumber(Randa_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Randa:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "◈︙عزيزي >>["..Randa2.username_.."](https://t.me/"..(Randa2.username_ or "OO0a0")..")\n◈︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Randa:teh"..msg.chat_id_).."} بجانب اسمك\n◈︙عدد المحاولات المتبقيه {"..(tonumber(Randa_nnn) - tonumber(Randa_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_Randaa_new)
end
end
...
local RandaChengName = database:get(bot_id.."Randa:Cheng:Name"..data.id_)
if not data.first_name_ then 
if RandaChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..RandaChengName..']')
database:del(bot_id.."Randa:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if RandaChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Randa:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local RandaChengUserName = database:get(bot_id.."Randa:Cheng:UserName"..data.id_)
if not data.username_ then 
if RandaChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..RandaChengUserName..']')
database:del(bot_id.."Randa:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if RandaChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Randa:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local RandaChengPhoto = database:get(bot_id.."Randa:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if RandaChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Randa:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if RandaChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Randa:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ʀᴀɴᴅᴀ\n\n[◈  ʀᴀɴᴅᴀ ᴄʜᴀɴɴᴇʟ](http://t.me/zZvzZo)\n\n[◈  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/OO0a0)\n\n[◈  ʀᴀɴᴅᴀ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/BBPBa)\n\n[◈  ʙᴏᴛ ʀᴀɴᴅᴀ](http://t.me/s7DaBot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '◈ sᴏᴜʀᴄʀ ʀᴀɴᴅᴀ',url="t.me/OO0a0/839"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/OO0a0&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevRandaW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *◈︙بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'OO0a0')..') \n*◈︙تـم قفـل الدردشه* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *◈︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'OO0a0')..') \n*◈︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevRandaW(msg) then
dofile('Randa.lua')  
send(msg.chat_id_, msg.id_, ' *◈︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevRandaW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevRandaW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if RandaSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevRandaW(msg) then
...
if RandaSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*◈︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevRandaW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevRandaW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevRandaW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevRandaW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevRandaW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevRandaW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevRandaW(msg) then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevRandaW(msg) then
...
if text == 'الملفات' and DevRandaW(msg) then
t = ' *◈︙ملفات السورس روليكس ↓*\n*•━━━━━━ 𝗥𝗮𝗡𝗗𝗮 ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevRandaW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/RandaTEAM/Files_Randa/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *◈︙اهلا بك في متجر ملفات روليكس*\n*◈︙ملفات السورس ↓*\n*•━━━━━━ 𝗥𝗮𝗡𝗗𝗮 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝗥𝗮𝗡𝗗𝗮 ━━━━━━━•*\n *◈︙علامة تعني { ✓ } ملف مفعل*\n *◈︙علامة تعني { ✘ } ملف معطل*\n *◈︙قناة سورس روليكس ↓*\n".." *◈︙*[اضغط هنا لدخول](t.me/OO0a0) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevRandaW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/RandaTEAM/Files_Randa/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('Randa.lua')  
else
send(msg.chat_id_, msg.id_," *◈︙عذرا الملف لايدعم سورس روليكس* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevRandaW(msg) then
...
if text == "مسح الملفات" and DevRandaW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *◈︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevRandaW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevRandaW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "OO0a0")
...
function Function_Randa(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Randa, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Randa, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *◈︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'OO0a0')..')'
status  = '\n*◈︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *◈︙العضو »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◈︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'OO0a0')..')'
...
database:set(bot_id.."Randa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end
if text then   
local tsssst = database:get(bot_id.."Randa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *◈︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."Randa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Randa1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Randa1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Randa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *◈︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."Randa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Randa1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Randa1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Randa1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then
send(msg.chat_id_, msg.id_," *◈︙ارسل الكلمه الان*")  
database:set(bot_id.."Randa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Randa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Randa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Randa1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Randa1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Randa1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Randa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Randa1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Randa1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n *◈︙قائمة المنع* \n*•━━━━━━ 𝗥𝗮𝗡𝗗𝗮 ━━━━━━━•*\n"
for k,v in pairs(list) do  
local Randa_Msg = database:get(bot_id.."Randa1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..Randa_Msg.."}\n"
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevRandaW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *◈︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevRandaW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *◈︙العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'OO0a0')..')'..'\n*◈︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevRandaW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevRandaW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..Randa_Msg[math.random(#Randa_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevRandaW(msg) then 
...
if RandaSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevRandaW(msg) then 
...
if text == ("ردود المطور") and DevRandaW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ◈︙قائمة ردود المطور \n*•━━━━━━ 𝗥𝗮𝗡𝗗𝗮 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevRandaW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevRandaW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevRandaW(msg) then   
...
if text == 'تعطيل المغادره' and DevRandaW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*◈︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Randa')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'OO0a0')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
Randadx(msg.chat_id_, msg.id_, ' *◈︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*◈︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*◈︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*◈︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevRandaW(msg) then
...
send(msg.chat_id_, msg.id_, t..'ٴ◈∫ٴ*•━━━━━━ 𝗥𝗮𝗡𝗗𝗮 ━━━━━━━•*ٴ◈∫○ٴ\n◈︙[𝙎𝙤𝙪𝙧𝘾𝙚 𝗥𝗮𝗡𝗗𝗮](t.me/OO0a0) ')
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙎𝙤𝙪𝙧𝘾𝙚 𝗥𝗮𝗡𝗗𝗮.',url="t.me/zZvzZo"}},
}
local msg_id = msg.id_/2097152/0.5
...
Randa = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Randa)
...
--------------------------------------------------------------------------------------------------------------
SourceRanda(data.message_,data)
...
------------------------------------------------------------------------
local RandaAbot = database:get(bot_id.."Randa1:Add:Filter:Rp2"..text..result.chat_id_)   
if RandaAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *◈︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n◈︙["..RandaAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Randa1_Msg = database:get(bot_id.."Randa1:Add:Filter:Rp2"..text..result.chat_id_)   
if Randa1_Msg then
send(msg.chat_id_, msg.id_," ◈︙"..Randa1_Msg)
