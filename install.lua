...
local RunBot = io.open("Randa", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/Randa
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr Randa.lua
wget "https://raw.githubusercontent.com/LARICATEAM/Randa/main/Randa.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./Randa.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S Randa -X kill
screen -S Randa ./Randa
done
]])
RunTs:close()
end
